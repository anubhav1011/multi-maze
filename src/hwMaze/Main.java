...
public class Main {
    ...
    private void read(String filename) throws IOException, ClassNotFoundException {
        hwMaze.MazeInputStream in =
                new hwMaze.MazeInputStream(new BufferedInputStream(new FileInputStream(filename)));
        maze = (hwMaze.Maze) in.readObject();
        //initDisplay();
    ...
    private void initDisplay() {
        ...
        if (cell_size >= 2) {
            ...
            hwMaze.MazeDisplay display = new hwMaze.MazeDisplay(maze);
